...
test('default content census exposes catalog breadth and Pack v2 ownership coverage separately', () => {
    ...
    assert.equal(counts.supplemental.npcSchedules, 11);
    assert.equal(counts.supplemental.contentPacks, 16);
    ...
    assert.equal(counts.supplemental.packOwnedByCollection.npcSchedules, 11);
