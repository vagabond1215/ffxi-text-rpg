...
test('default content census exposes catalog breadth and Pack v2 ownership coverage separately', () => {
    ...
    assert.equal(counts.supplemental.npcSchedules, 17);
    assert.equal(counts.supplemental.contentPacks, 23);
    ...
    assert.equal(counts.supplemental.packOwnedByCollection.npcSchedules, 17);
