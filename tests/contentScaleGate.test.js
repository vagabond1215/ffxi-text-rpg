...
test('default content census exposes catalog breadth and Pack v2 ownership coverage separately', () => {
    ...
    assert.equal(counts.supplemental.npcSchedules, 21);
    assert.equal(counts.supplemental.contentPacks, 27);
    ...
    assert.equal(counts.supplemental.packOwnedByCollection.npcSchedules, 21);
