...
test('default content census exposes catalog breadth and Pack v2 ownership coverage separately', () => {
    ...
    assert.equal(counts.supplemental.npcSchedules, 19);
    assert.equal(counts.supplemental.contentPacks, 25);
    ...
    assert.equal(counts.supplemental.packOwnedByCollection.npcSchedules, 19);
