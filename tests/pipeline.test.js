...
test('version manifest separates product package persistence data and focused cleanup versions', () => {
    assert.equal(PRODUCT_VERSION, '0.8.600.19');
    ...
    assert.equal(VERSION.codename, 'Strict Active Travel');
    ...
    assert.deepEqual(
        ...
        {
            versionManifest: '0.8.600.19',
            actionResults: '0.2.0',
            performanceHarness: '0.3.0',
            lifecycleHarness: '0.10.0',
            timedTasks: '0.2.0',
            projects: '0.2.0',
    ...
    assert.match(describeVersion(), /Product: 0\.8\.600\.19/);
    ...
    assert.match(describeVersion(), /Codename: Strict Active Travel/);
    ...
    assert.match(describeSystemVersions(), /lifecycleHarness: 0\.10\.0/);
    ...
    assert.match(describeSystemVersions(), /validation: 0\.12\.0/);
