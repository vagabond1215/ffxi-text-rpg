...
test('version manifest separates product package persistence data and scale-content versions', () => {
    ...
    assert.equal(VERSION.codename, 'Headwater Vale & Waymeet Approach');
    ...
    assert.match(describeVersion(), /Product: 0\.9\.100\.13/);
    ...
    assert.match(describeVersion(), /Data: 52/);
    assert.match(describeVersion(), /Benchmark: 3/);
    assert.match(describeVersion(), /Codename: Headwater Vale & Waymeet Approach/);
    ...
    assert.match(describeSystemVersions(), /regionalContentPacks: 0\.11\.0/);
    ...
    assert.match(describeSystemVersions(), /productionCatalog: 0\.9\.0/);
    assert.match(describeSystemVersions(), /productionItems: 0\.10\.0/);
    assert.match(describeSystemVersions(), /capabilities: 0\.5\.0/);
    assert.match(describeSystemVersions(), /abilityCatalog: 0\.4\.0/);
    assert.match(describeSystemVersions(), /npcSchedules: 0\.4\.0/);
