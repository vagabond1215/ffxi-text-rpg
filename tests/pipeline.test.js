...
test('version manifest separates product package persistence data and scale-content versions', () => {
    ...
    assert.equal(VERSION.codename, 'Legacy Elderwood Ecology Repair');
    ...
    assert.match(describeVersion(), /Product: 0\.9\.100\.18/);
    ...
    assert.match(describeVersion(), /Data: 58/);
    assert.match(describeVersion(), /Benchmark: 3/);
    assert.match(describeVersion(), /Codename: Legacy Elderwood Ecology Repair/);
    ...
    assert.match(describeSystemVersions(), /regionalContentPacks: 0\.17\.0/);
    ...
    assert.match(describeSystemVersions(), /productionCatalog: 0\.15\.0/);
    assert.match(describeSystemVersions(), /productionItems: 0\.16\.0/);
