...
test('version manifest separates product package persistence data and scale-content versions', () => {
    ...
    assert.equal(VERSION.codename, 'Remaining Bronze Starter Set Conversion Proof');
    ...
    assert.match(describeVersion(), /Product: 0\.9\.400\.5/);
    ...
    assert.match(describeVersion(), /Data: 79/);
    assert.match(describeVersion(), /Benchmark: 3/);
    assert.match(describeVersion(), /Codename: Remaining Bronze Starter Set Conversion Proof/);
    ...
    assert.match(describeSystemVersions(), /regionalContentPacks: 0\.26\.0/);
    ...
    assert.match(describeSystemVersions(), /productionCatalog: 0\.21\.0/);
