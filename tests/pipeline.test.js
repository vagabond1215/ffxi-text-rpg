...
test('version manifest separates product package persistence data and scale-content versions', () => {
    ...
    assert.equal(VERSION.codename, 'Emberwash Badlands & Cinderwell Station');
    ...
    assert.match(describeVersion(), /Product: 0\.9\.100\.16/);
    ...
    assert.match(describeVersion(), /Data: 55/);
    assert.match(describeVersion(), /Benchmark: 3/);
    assert.match(describeVersion(), /Codename: Emberwash Badlands & Cinderwell Station/);
    ...
    assert.match(describeSystemVersions(), /regionalContentPacks: 0\.14\.0/);
    ...
    assert.match(describeSystemVersions(), /productionCatalog: 0\.12\.0/);
    assert.match(describeSystemVersions(), /productionItems: 0\.13\.0/);
    assert.match(describeSystemVersions(), /capabilities: 0\.5\.0/);
    assert.match(describeSystemVersions(), /abilityCatalog: 0\.4\.0/);
    assert.match(describeSystemVersions(), /npcSchedules: 0\.7\.0/);
