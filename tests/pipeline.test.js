...
test('version manifest separates product package persistence data and focused cleanup versions', () => {
    assert.equal(PRODUCT_VERSION, '0.8.600.47');
    ...
    assert.equal(VERSION.codename, 'Strict Battle Player Link');
    ...
    assert.deepEqual(
        {
            ...
            activeBattlePlayerLinkPersistence: SYSTEM_VERSIONS.activeBattlePlayerLinkPersistence,
        ...
        },
        {
            ...
            activeBattlePlayerLinkPersistence: '0.1.0',
    ...
    assert.match(describeVersion(), /Product: 0\.8\.600\.47/);
    ...
    assert.match(describeVersion(), /Codename: Strict Battle Player Link/);
    assert.match(describeVersion(), /Compatibility: pre-release-current-schema/);
    assert.match(describeSystemVersions(), /validation: 0\.38\.0/);
    ...
    assert.match(describeSystemVersions(), /activeBattlePlayerLinkPersistence: 0\.1\.0/);
    ...
    assert.match(describeSystemVersions(), /saveEncoding: 0\.6\.0/);
