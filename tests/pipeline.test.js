...
test('version manifest separates product package persistence data and focused cleanup versions', () => {
    assert.equal(PRODUCT_VERSION, '0.8.600.51');
    ...
    assert.equal(VERSION.codename, 'Derived Enemy Encounter Projection');
    ...
    assert.match(describeSystemVersions(), /saveEncoding: 0\.8\.0/);
