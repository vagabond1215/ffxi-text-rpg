...
export const vendorInventories = {
  ...
  'Samigo-Pormigo': ['boneworkersBelt'],
  Andreas: ['carpentersBelt'],
  'Qhum Knaidjn': ['culinariansBelt'],
...
export const vendorGreetings = {
  ...
  Hemewmew: 'Alchemy belts for dedicated crafters.',
  ...
  'Samigo-Pormigo': 'Bonecraft belts to hone your skill.',
  Andreas: 'Woodworking belts fashioned with care.',
  'Qhum Knaidjn': 'Cooking belts hot off the stove.',
