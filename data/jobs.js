export const jobs = [
  ...
  },
  {
    ...
    traits: [
      { name: 'Max HP Boost I', effect: 'Raises maximum HP', level: 10 },
      { name: 'Counter I', effect: 'Chance to counterattack', level: 15 },
      { name: 'Martial Arts I', effect: 'Reduces hand-to-hand delay', level: 20 },
      { name: 'Subtle Blow I', effect: 'Reduces enemy TP gain', level: 30 },
      { name: 'Max HP Boost II', effect: 'Raises maximum HP further', level: 30 },
      { name: 'Kick Attacks', effect: 'Adds kick attacks to attacks', level: 40 },
      { name: 'Counter II', effect: 'Higher chance to counterattack', level: 55 },
      { name: 'Martial Arts II', effect: 'Further reduces hand-to-hand delay', level: 60 },
      { name: 'Subtle Blow II', effect: 'Further reduces enemy TP gain', level: 65 },
      { name: 'Max HP Boost III', effect: 'Greatly increases maximum HP', level: 70 }
    ],
    abilities: [
      ...
      { name: 'Counterstance', effect: 'Replaces defense with counter rate', level: 30 },
      { name: 'Chakra', effect: 'Restores HP', level: 35 },
      { name: 'Chi Blast', effect: 'Deals damage with Chi', level: 41 },
      { name: 'Formless Strikes', effect: 'Ignores enemy resistances', level: 50 },
      { name: 'Mantra', effect: 'Raises party HP', level: 50 },
      { name: 'Footwork', effect: 'Enhances kick attacks', level: 65 },
      { name: 'Impetus', effect: 'Boosts attack after consecutive hits', level: 85 },
      { name: 'Perfect Counter', effect: 'Counters next attack with high damage', level: 96 },
  ...
  },
  {
    ...
    traits: [
      { name: 'Clear Mind I', effect: 'Improves MP recovery while resting', level: 10 },
      { name: 'Conserve MP', effect: 'Chance to use less MP', level: 20 },
      { name: 'Auto Refresh', effect: 'Regenerates MP over time', level: 45 },
      { name: 'Magic Defense Bonus I', effect: 'Boosts magic defense', level: 50 },
      { name: 'Divine Benison', effect: 'Reduces enmity from cures', level: 78 }
    ],
    abilities: [
      ...
      { name: 'Divine Caress', effect: 'Enhances next status removal', level: 40 },
  ...
  },
  {
    ...
    traits: [
      { name: 'Fast Cast I', effect: 'Shortens casting time', level: 10 },
