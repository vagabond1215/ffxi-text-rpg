...
export function createPlayerCharacter(options = {}) {
    ...
    const entity = {
        ...
        identity: {
            ...
            nation: options.nation ?? 'Thornwall',
            startingCity: options.startingCity ?? 'Thornwall Southgate',
            title: options.title ?? 'Newcomer',
        },
        jobs: {
            ...
            unlockedJobs: ['vanguard', 'pugilist', 'lifewarden', 'elementalist', 'spellblade', 'shadowhand'],
            jobLevels: {
                [mainJob.id]: level,
            },
            levelCap,
