...
export const REGIONAL_CONTENT_PACK_DATA_VERSION = 26;
...
export const SHARED_FOUNDATION_PACK = createContentPack({
    ...
    metadata: {
        ...
        notes: 'Cross-region transport, training, and executable capability records shared by regional packs without duplicating stable-ID ownership.',
    },
    records: {
        routes: [
        ...
        spellSchools: [
            { id: 'school-embercraft', catalogRef: true },
            { id: 'school-vital-weave', catalogRef: true },
            { id: 'school-ward-lore', catalogRef: true },
        ],
        capabilities: [
...
export const ELDERWOOD_PACK = createContentPack({
    ...
    records: {
        ...
        items: [
            ...
            {
                id: 'item-elderwood-root-tonic', name: 'Sweetroot Field Tonic', kind: 'consumable',
                provenance: [{ version: 1, type: 'crafting', sourceId: 'recipe-elderwood-root-tonic', placeId: 'timbercross-landing', action: 'craft', exceptional: false, notes: '', data: {} }],
                sinks: [{ type: 'consume', targetId: null, notes: '', data: {} }, { type: 'trade', targetId: null, notes: '', data: {} }],
            },
        ],
        npcs: [
            { id: 'npc-thornwall-sera-talwin', catalogRef: true },
            { id: 'npc-thornwall-mira-fen', catalogRef: true },
            { id: 'npc-elderwood-waywarden', catalogRef: true },
        ],
        npcSchedules: [
            { id: 'schedule-thornwall-sera-talwin', catalogRef: true },
            { id: 'schedule-thornwall-mira-fen', catalogRef: true },
        ],
        ...
        quests: [
            ...
            { id: 'commitment-thornwall-sweetroot-return', catalogRef: true },
            { id: 'commitment-thornwall-hearth-sweetroot-share', catalogRef: true },
        ],
...
export const REDSTONE_PACK = createContentPack({
    id: 'pack-redstone-opening',
    dataVersion: REGIONAL_CONTENT_PACK_DATA_VERSION,
    ownership: { scope: 'region', regionIds: ['redstone-reach'], steward: 'brasshaven-south' },
    dependencies: ['pack-shared-foundation'],
    metadata: { name: 'Redstone Opening Pack', notes: 'Ownership manifest for existing Brasshaven people, schedules, commitments, and the Redstone regional root before high-volume expansion.' },
    records: {
        places: [{ id: 'brasshaven-market-ring', catalogRef: true }],
        npcs: [
            { id: 'npc-brasshaven-marshal-varric-stone', catalogRef: true },
            { id: 'npc-brasshaven-mae-oris', catalogRef: true },
        ],
        npcSchedules: [{ id: 'schedule-brasshaven-mae-oris', catalogRef: true }],
        quests: [
            { id: 'commitment-brasshaven-copper-return', catalogRef: true },
            { id: 'commitment-brasshaven-courtyard-sweetroot-share', catalogRef: true },
        ],
    },
});
...
export const STARFEN_PACK = createContentPack({
    ...
    records: {
        places: [
            { id: 'mistmere-canal-ward', catalogRef: true },
        ...
        items: [
            ...
            {
                id: 'item-starfen-field-dressing', name: 'Fenfield Dressing', kind: 'consumable',
                provenance: [{ version: 1, type: 'crafting', sourceId: 'recipe-starfen-field-dressing', placeId: 'west-starfen', action: 'craft', exceptional: false, notes: '', data: {} }],
                sinks: [{ type: 'consume', targetId: null, notes: '', data: {} }, { type: 'contract', targetId: 'quest-starfen-ferry-supplies', notes: '', data: {} }],
            },
        ],
        npcs: [
            { id: 'npc-mistmere-reader-soli-venn', catalogRef: true },
            { id: 'npc-mistmere-kiri-fen', catalogRef: true },
            { id: 'npc-starfen-ferrymaster', name: 'Ilyan Reed', placeId: 'mistmere-reedport', services: ['ferry-booking', 'contracts'] },
        ],
        ...
        quests: [
            ...
            { id: 'commitment-mistmere-marrowleaf-return', catalogRef: true },
            { id: 'commitment-mistmere-canalside-sweetroot-share', catalogRef: true },
        ],
