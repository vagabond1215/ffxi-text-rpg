...
export const REGIONAL_CONTENT_PACK_DATA_VERSION = 25;
...
export const SHARED_FOUNDATION_PACK = createContentPack({
    ...
    dependencies: [],
    metadata: { name: 'Shared World Foundation', notes: 'Cross-region transport records shared by regional packs without duplicating stable-ID ownership.' },
    records: {
...
export const ELDERWOOD_PACK = createContentPack({
    ...
    records: {
        ...
        npcs: [{ id: 'npc-elderwood-waywarden', name: 'Mara Venn', placeId: 'timbercross-landing', services: ['route-guidance', 'contracts'] }],
        ...
        quests: [{ id: 'quest-elderwood-road-repair', name: 'Timber for the Work Road', giverNpcId: 'npc-elderwood-waywarden', placeId: 'timbercross-landing', objectives: [{ type: 'deliverItem', itemId: 'item-elderwood-hardwood', quantity: 2 }], rewards: [{ type: 'item', itemId: 'item-elderwood-root-tonic', quantity: 1 }] }],
...
export const STARFEN_PACK = createContentPack({
    ...
    records: {
        places: [{ id: 'mistmere-reedport', catalogRef: true }, { id: 'west-starfen', catalogRef: true }],
        ...
        npcs: [{ id: 'npc-starfen-ferrymaster', name: 'Ilyan Reed', placeId: 'mistmere-reedport', services: ['ferry-booking', 'contracts'] }],
        ...
        quests: [{ id: 'quest-starfen-ferry-supplies', name: 'Timber for the West Ferry', giverNpcId: 'npc-starfen-ferrymaster', placeId: 'mistmere-reedport', objectives: [{ type: 'deliverItem', itemId: 'item-elderwood-hardwood', quantity: 2 }], rewards: [{ type: 'item', itemId: 'item-starfen-field-dressing', quantity: 1 }] }],
