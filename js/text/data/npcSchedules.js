...
const DAILY_SCHEDULES = [
    ...
    schedule({
        id: 'schedule-lantern-sump-ressa-kell',
        npcId: 'npc-lantern-sump-ressa-kell',
        poiId: 'poi-lantern-sump-exchange',
        placeId: 'lantern-sump-station',
        label: 'Lantern Sump exchange hours',
        windows: [window(6, 0, 16, 0, 'Weighing cave finds, provisions, lamp stock, and repair goods')],
        unavailableText: 'Ressa has closed the exchange scales and is checking stores, lamp stock, or incoming delver lots.',
    }),
    schedule({
        id: 'schedule-lantern-sump-borin-vale',
        npcId: 'npc-lantern-sump-borin-vale',
        poiId: 'poi-lantern-sump-survey-desk',
        placeId: 'lantern-sump-station',
        label: 'Lower Deepvein survey desk',
        windows: [window(7, 0, 18, 0, 'Posting gallery, seep, loose-rock, and traverse conditions')],
        unavailableText: 'Borin is away from the survey desk checking markers, timbered ledges, seep crossings, or the Echoing Shelf traverse.',
    }),
    schedule({
