...
const COMMITMENT_DEFINITIONS = Object.freeze({
    ...
    'commitment-brasshaven-iron-bloom-return': commitment({
        id: 'commitment-brasshaven-iron-bloom-return', name: 'Iron for Foundry Hall', giverNpcId: 'npc-brasshaven-marshal-varric-stone', offerPoiId: 'poi-bastok-markets-rabid-wolf', offerPlaceId: 'brasshaven-market-ring',
        description: 'Foundry crews want one bloom that can be traced from Redstone ore through a real forge rather than a market purchase.', objective: 'Bring Varric one Redstone Iron Bloom smelted from South Redstone ore.',
        ...
        offerText: 'Varric asks for a single iron bloom whose work marks still tell the whole story: ore from the Reach, a forge, and your own metalworking.', resolvedText: 'Varric weighs the bloom, checks the slag line, and sends it onward to Foundry Hall with your name attached to the batch.', followUpText: 'The next day Varric notes that the bloom was sound but ordinary. Foundry Hall is paying more attention to people who can refine flux and temper iron without wasting either material.',
    }),
    ...
    'commitment-brasshaven-caravan-shoes': commitment({
        id: 'commitment-brasshaven-caravan-shoes', name: 'Shoes for the Forge Road', giverNpcId: 'npc-brasshaven-marshal-varric-stone', offerPoiId: 'poi-bastok-markets-rabid-wolf', offerPlaceId: 'brasshaven-market-ring',
        description: 'The Forge Road caravan pool needs replacement iron shoes fabricated from the same tempered stock used for civic repairs.', objective: 'Bring Varric two Redstone Caravan Shoes forged from tempered Redstone iron and matching rivets.',
