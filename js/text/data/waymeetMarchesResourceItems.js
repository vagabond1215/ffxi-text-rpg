...
const DEFINITIONS = Object.freeze({
    ...
    'item-waymeet-peat-turf': resource({ id:'item-waymeet-peat-turf', name:'South March Peat Turf', tags:['organic','fuel','peat','roadwork','waymeet-marches'], valueGil:7, sourceId:'source-waymeet-peat-cut', placeId:'waymeet-south-marches', action:'gather', provenanceType:'flora', sinks:['processInput','craftIngredient','trade'] }),
