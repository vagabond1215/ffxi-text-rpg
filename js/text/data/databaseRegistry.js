export const DATABASES = Object.freeze({
    ...
    quests: database('quests', 'Quest and commission definitions, objectives, prerequisites, rewards, repeatability, flags.', 'seeded-pack-fixture', '0.1.0'),
    relationships: database('relationships', 'Relationship records tying persistent NPCs to trust/respect/familiarity and quest hooks.', 'seeded-pack-fixture', '0.1.0'),
    ...
    companions: database('companions', 'Persistent NPC-backed companion definitions, recruitment conditions, relationship dimensions, tactical roles, and combat integration.', 'implemented', '0.1.0'),
    party: database('party', 'Persistent recruited-companion membership, active-party capacity, location continuity, and battle synchronization.', 'implemented', '0.1.0'),
