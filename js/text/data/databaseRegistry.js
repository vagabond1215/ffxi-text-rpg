export const DATABASES = Object.freeze({
    ...
    productionItems: database('productionItems', 'Canonical processed materials, crafted goods, meals, and salvage outputs with provenance and explicit economic, construction, repair, consumption, and transformation sinks.', 'seeded', '0.2.0'),
    ...
    homeInfrastructure: database('homeInfrastructure', 'Authored home and foothold improvements that consume canonical materials and project labor to grant durable storage or workstation capability through existing furnishing, workstation, production, and inventory authority.', 'implemented', '0.2.0'),
