...
export const THORNWALL_TOPOLOGIES = Object.freeze({
    southgate: cityTopology({
        start: 'G-10',
        navigable: [
            'E-8', 'E-9',
            'F-7', 'F-8', 'F-9', 'F-10',
        ...
        exits: [
            exit('I-7', ['north'], 'thornwall-crownward', 'I-10', 20),
            exit('F-10', ['west', 'southwest'], 'west-elderwood', 'I-6', 45),
            exit('L-10', ['east', 'southeast'], 'east-elderwood', 'G-4', 45),
            exit('H-11', ['south'], 'thornwall-strider-yard', 'H-8', 20),
        ],
    }),
    crownward: cityTopology({
        start: 'I-10',
        navigable: [
            'C-8', 'D-7', 'D-8',
        ...
        exits: [
            exit('F-5', ['north'], 'timbercross-landing', 'G-7', 30),
            exit('I-6', ['north'], 'thornwall-high-citadel', 'H-9', 20),
            exit('F-3', ['north'], 'thornwall-rivergate', 'F-10', 25),
            exit('I-10', ['south'], 'thornwall-southgate', 'I-7', 20),
            exit('C-8', ['west'], 'west-elderwood', 'I-5', 45),
            exit('D-7', ['west', 'southwest'], 'west-elderwood', 'I-5', 45),
        ],
    }),
    rivergate: cityTopology({
        start: 'F-10',
        navigable: ['F-10', 'G-10', 'H-10', 'H-9', 'H-8', 'H-7', 'H-6', 'H-5'],
        exits: [
            exit('F-10', ['north'], 'thornwall-crownward', 'F-3', 25),
            exit('H-5', ['north'], 'skyferry-waymeet-thornwall', 'H-5', 60, { externalPlaceholder: true }),
        ],
    }),
    highCitadel: cityTopology({
        start: 'H-9',
        navigable: ['H-9', 'I-9', 'I-8', 'H-8'],
        exits: [
            exit('H-9', ['south'], 'thornwall-crownward', 'I-6', 20),
            exit('I-8', ['north'], 'thornwall-old-gaol', 'H-6', 30),
        ],
    }),
