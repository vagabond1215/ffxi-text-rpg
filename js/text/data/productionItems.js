...
import { getDryUplandSaltpanRepairProductionItem, listDryUplandSaltpanRepairProductionItems } from './dryUplandSaltpanRepairProductionItems.js';
...
import { getHeadwaterProductionItem, listHeadwaterProductionItems } from './headwaterProductionItems.js';
import { getHeadwaterHighlandTransitionRepairProductionItem, listHeadwaterHighlandTransitionRepairProductionItems } from './headwaterHighlandTransitionRepairProductionItems.js';
import { getIronspineProductionItem, listIronspineProductionItems } from './ironspineProductionItems.js';
import { getLowerDeepveinProductionItem, listLowerDeepveinProductionItems } from './lowerDeepveinProductionItems.js';
import { getWaymeetMarchesProductionItem, listWaymeetMarchesProductionItems } from './waymeetMarchesProductionItems.js';
...
export const PRODUCTION_ITEM_CATALOG_VERSION = 17;
...
const PRODUCTION_ITEM_DEFINITIONS = Object.freeze({
    ...
    'item-silverfin-sweetroot-stew': productionItem({ id: 'item-silverfin-sweetroot-stew', name: 'Silverfin Sweetroot Stew', kind: ITEM_KINDS.CONSUMABLE, tags: ['food', 'meal', 'cooked', 'starfen'], valueGil: 24, sourceId: 'cook-silverfin-sweetroot-stew', action: 'craft', consumption: { mode: 'direct', hazard: 'none', preparation: [], notes: 'Fully cooked meal; safe to eat as served.' }, sinks: ['consume', 'trade'] }),
    ...
    'item-elderwood-tanned-hide': productionItem({ id: 'item-elderwood-tanned-hide', name: 'Dusk-Tanned Barkboar Hide', kind: ITEM_KINDS.MATERIAL, tags: ['hide', 'leather', 'component', 'elderwood'], valueGil: 44, sourceId: 'process-elderwood-tanned-hide', action: 'process', sinks: ['craftIngredient', 'repair', 'contract', 'trade'] }),
    'item-elderwood-resin-pitch': productionItem({ id: 'item-elderwood-resin-pitch', name: 'Amber Resin Pitch', kind: ITEM_KINDS.MATERIAL, tags: ['resin', 'sealant', 'component', 'elderwood'], valueGil: 30, sourceId: 'process-elderwood-resin-pitch', action: 'process', sinks: ['craftIngredient', 'construction', 'repair', 'trade'] }),
    'item-elderwood-forester-gloves': productionItem({ id: 'item-elderwood-forester-gloves', name: 'Forester Grip Gloves', kind: ITEM_KINDS.EQUIPMENT, tags: ['equipment', 'armor', 'hands', 'forestry', 'elderwood'], valueGil: 88, sourceId: 'craft-elderwood-forester-gloves', action: 'craft', sinks: ['equipment', 'repair', 'contract', 'trade'], equipmentSlot: 'hands', allowedSlots: ['hands'], modifiers: { attributes: { dex: 1 }, derived: { defense: 2 } } }),
    'item-elderwood-hunters-bracer': productionItem({ id: 'item-elderwood-hunters-bracer', name: "Hunter's Timber Bracer", kind: ITEM_KINDS.EQUIPMENT, tags: ['equipment', 'armor', 'waist', 'hunting', 'elderwood'], valueGil: 84, sourceId: 'craft-elderwood-hunters-bracer', action: 'craft', sinks: ['equipment', 'repair', 'trade'], equipmentSlot: 'waist', allowedSlots: ['waist'], modifiers: { attributes: { agi: 1 }, derived: { defense: 1 } } }),
    'item-elderwood-trail-repair-bundle': productionItem({ id: 'item-elderwood-trail-repair-bundle', name: 'Elderwood Trail Repair Bundle', kind: ITEM_KINDS.MATERIAL, tags: ['wood', 'hide', 'resin', 'repair', 'roadwork', 'elderwood'], valueGil: 48, sourceId: 'craft-elderwood-trail-repair-bundle', action: 'craft', sinks: ['construction', 'repair', 'contract', 'trade'] }),
    'item-elderwood-waywarden-mantle': productionItem({ id: 'item-elderwood-waywarden-mantle', name: 'Waywarden Weather Mantle', kind: ITEM_KINDS.EQUIPMENT, tags: ['equipment', 'armor', 'body', 'travel', 'hunting', 'elderwood'], valueGil: 118, sourceId: 'craft-elderwood-waywarden-mantle', action: 'craft', sinks: ['equipment', 'repair', 'trade'], equipmentSlot: 'body', allowedSlots: ['body'], modifiers: { attributes: { agi: 1 }, derived: { defense: 3 } } }),
    ...
    'item-starfen-bluekelp-broth': productionItem({ id: 'item-starfen-bluekelp-broth', name: 'Bluekelp Silverfin Broth', kind: ITEM_KINDS.CONSUMABLE, tags: ['food', 'meal', 'cooked', 'starfen'], valueGil: 27, sourceId: 'cook-starfen-bluekelp-broth', action: 'craft', consumption: { mode: 'direct', hazard: 'none', preparation: [], notes: 'Fully cooked broth; safe to eat as served.' }, sinks: ['consume', 'trade'] }),
