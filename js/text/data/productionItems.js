...
const PRODUCTION_ITEM_DEFINITIONS = Object.freeze({
    ...
    'item-elderwood-hide-binding': productionItem({ id: 'item-elderwood-hide-binding', name: 'Resin-Cured Hide Binding', kind: ITEM_KINDS.MATERIAL, tags: ['hide', 'binding', 'component', 'elderwood'], valueGil: 34, sourceId: 'craft-elderwood-hide-binding', action: 'craft', sinks: ['craftIngredient', 'repair', 'trade'] }),
