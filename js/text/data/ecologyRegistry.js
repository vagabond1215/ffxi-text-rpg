...
import {
    getCrossBiomeFamilyBreadthEcologyFamily,
    getCrossBiomeFamilyBreadthGatheringSource,
    getCrossBiomeFamilyBreadthPopulation,
    getCrossBiomeFamilyBreadthSpecies,
    ...
    validateCrossBiomeFamilyBreadthEcology,
} from './crossBiomeFamilyBreadthEcology.js';
import {
    getWetlandIslandDistributionRepairEcologyFamily,
    getWetlandIslandDistributionRepairGatheringSource,
    getWetlandIslandDistributionRepairPopulation,
    getWetlandIslandDistributionRepairSpecies,
    ...
    validateWetlandIslandDistributionRepairEcology,
...
export function getCanonicalEcologyFamily(id) { return getEcologyFamily(id) ?? getRegionalEcologyFamily(id) ?? getCrossBiomeFamilyBreadthEcologyFamily(id) ?? getWetlandIslandDistributionRepairEcologyFamily(id) ?? getHeadwaterHighlandTransitionRepairEcologyFamily(id) ?? getDryUplandSaltpanRepairEcologyFamily(id) ?? getElderwoodRepairEcologyFamily(id) ?? getEmberwashEcologyFamily(id) ?? getLowerDeepveinEcologyFamily(id) ?? getGreatMereEcologyFamily(id) ?? getIronspineEcologyFamily(id) ?? getHeadwaterEcologyFamily(id) ?? getStarfenDeltaEcologyFamily(id) ?? getGloamwoodEcologyFamily(id) ?? getWaymeetMarchesEcologyFamily(id); }
export function getCanonicalSpecies(id) { return getSpecies(id) ?? getRegionalSpecies(id) ?? getCrossBiomeFamilyBreadthSpecies(id) ?? getWetlandIslandDistributionRepairSpecies(id) ?? getHeadwaterHighlandTransitionRepairSpecies(id) ?? getDryUplandSaltpanRepairSpecies(id) ?? getElderwoodRepairSpecies(id) ?? getEmberwashSpecies(id) ?? getLowerDeepveinSpecies(id) ?? getGreatMereSpecies(id) ?? getIronspineSpecies(id) ?? getHeadwaterSpecies(id) ?? getStarfenDeltaSpecies(id) ?? getGloamwoodSpecies(id) ?? getWaymeetMarchesSpecies(id); }
export function getCanonicalPopulation(id) { return getPopulation(id) ?? getRegionalPopulation(id) ?? getCrossBiomeFamilyBreadthPopulation(id) ?? getWetlandIslandDistributionRepairPopulation(id) ?? getHeadwaterHighlandTransitionRepairPopulation(id) ?? getDryUplandSaltpanRepairPopulation(id) ?? getElderwoodRepairPopulation(id) ?? getEmberwashPopulation(id) ?? getLowerDeepveinPopulation(id) ?? getGreatMerePopulation(id) ?? getIronspinePopulation(id) ?? getHeadwaterPopulation(id) ?? getStarfenDeltaPopulation(id) ?? getGloamwoodPopulation(id) ?? getWaymeetMarchesPopulation(id); }
export function getCanonicalGatheringSource(id) { return getGatheringSource(id) ?? getRegionalGatheringSource(id) ?? getCrossBiomeFamilyBreadthGatheringSource(id) ?? getWetlandIslandDistributionRepairGatheringSource(id) ?? getHeadwaterHighlandTransitionRepairGatheringSource(id) ?? getDryUplandSaltpanRepairGatheringSource(id) ?? getElderwoodRepairGatheringSource(id) ?? getEmberwashGatheringSource(id) ?? getLowerDeepveinGatheringSource(id) ?? getGreatMereGatheringSource(id) ?? getIronspineGatheringSource(id) ?? getHeadwaterGatheringSource(id) ?? getStarfenDeltaGatheringSource(id) ?? getGloamwoodGatheringSource(id) ?? getWaymeetMarchesGatheringSource(id) ?? getMaterialFoundationGatheringSource(id); }

export function listCanonicalEcologyFamilies() { return unique([...listEcologyFamilies(), ...listRegionalEcologyFamilies(), ...listCrossBiomeFamilyBreadthEcologyFamilies(), ...listWetlandIslandDistributionRepairEcologyFamilies(), ...listHeadwaterHighlandTransitionRepairEcologyFamilies(), ...listDryUplandSaltpanRepairEcologyFamilies(), ...listElderwoodRepairEcologyFamilies(), ...listEmberwashEcologyFamilies(), ...listLowerDeepveinEcologyFamilies(), ...listGreatMereEcologyFamilies(), ...listIronspineEcologyFamilies(), ...listHeadwaterEcologyFamilies(), ...listStarfenDeltaEcologyFamilies(), ...listGloamwoodEcologyFamilies(), ...listWaymeetMarchesEcologyFamilies()]); }
export function listCanonicalSpecies() { return unique([...listSpecies(), ...listRegionalSpecies(), ...listCrossBiomeFamilyBreadthSpecies(), ...listWetlandIslandDistributionRepairSpecies(), ...listHeadwaterHighlandTransitionRepairSpecies(), ...listDryUplandSaltpanRepairSpecies(), ...listElderwoodRepairSpecies(), ...listEmberwashSpecies(), ...listLowerDeepveinSpecies(), ...listGreatMereSpecies(), ...listIronspineSpecies(), ...listHeadwaterSpecies(), ...listStarfenDeltaSpecies(), ...listGloamwoodSpecies(), ...listWaymeetMarchesSpecies()]); }
export function listCanonicalPopulations() { return unique([...listPopulations(), ...listRegionalPopulations(), ...listCrossBiomeFamilyBreadthPopulations(), ...listWetlandIslandDistributionRepairPopulations(), ...listHeadwaterHighlandTransitionRepairPopulations(), ...listDryUplandSaltpanRepairPopulations(), ...listElderwoodRepairPopulations(), ...listEmberwashPopulations(), ...listLowerDeepveinPopulations(), ...listGreatMerePopulations(), ...listIronspinePopulations(), ...listHeadwaterPopulations(), ...listStarfenDeltaPopulations(), ...listGloamwoodPopulations(), ...listWaymeetMarchesPopulations()]); }
...
export function validateEcologyRegistry() {
    const issues = [
        ...
        ...validateCrossBiomeFamilyBreadthEcology().map((issue) => `[crossBiomeFamilyBreadth] ${issue}`),
        ...validateWetlandIslandDistributionRepairEcology().map((issue) => `[wetlandIslandDistributionRepair] ${issue}`),
    ...
    const collections = [
        ['family', [...listEcologyFamilies(), ...listRegionalEcologyFamilies(), ...listCrossBiomeFamilyBreadthEcologyFamilies(), ...listWetlandIslandDistributionRepairEcologyFamilies(), ...listHeadwaterHighlandTransitionRepairEcologyFamilies(), ...listDryUplandSaltpanRepairEcologyFamilies(), ...listElderwoodRepairEcologyFamilies(), ...listEmberwashEcologyFamilies(), ...listLowerDeepveinEcologyFamilies(), ...listGreatMereEcologyFamilies(), ...listIronspineEcologyFamilies(), ...listHeadwaterEcologyFamilies(), ...listStarfenDeltaEcologyFamilies(), ...listGloamwoodEcologyFamilies(), ...listWaymeetMarchesEcologyFamilies()]],
        ['species', [...listSpecies(), ...listRegionalSpecies(), ...listCrossBiomeFamilyBreadthSpecies(), ...listWetlandIslandDistributionRepairSpecies(), ...listHeadwaterHighlandTransitionRepairSpecies(), ...listDryUplandSaltpanRepairSpecies(), ...listElderwoodRepairSpecies(), ...listEmberwashSpecies(), ...listLowerDeepveinSpecies(), ...listGreatMereSpecies(), ...listIronspineSpecies(), ...listHeadwaterSpecies(), ...listStarfenDeltaSpecies(), ...listGloamwoodSpecies(), ...listWaymeetMarchesSpecies()]],
