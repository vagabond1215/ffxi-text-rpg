...
export function getCanonicalEcologyFamily(id) { return getEcologyFamily(id) ?? getRegionalEcologyFamily(id) ?? getDryUplandSaltpanRepairEcologyFamily(id) ?? getElderwoodRepairEcologyFamily(id) ?? getEmberwashEcologyFamily(id) ?? getLowerDeepveinEcologyFamily(id) ?? getGreatMereEcologyFamily(id) ?? getIronspineEcologyFamily(id) ?? getHeadwaterEcologyFamily(id) ?? getStarfenDeltaEcologyFamily(id) ?? getGloamwoodEcologyFamily(id) ?? getWaymeetMarchesEcologyFamily(id); }
export function getCanonicalSpecies(id) { return getSpecies(id) ?? getRegionalSpecies(id) ?? getDryUplandSaltpanRepairSpecies(id) ?? getElderwoodRepairSpecies(id) ?? getEmberwashSpecies(id) ?? getLowerDeepveinSpecies(id) ?? getGreatMereSpecies(id) ?? getIronspineSpecies(id) ?? getHeadwaterSpecies(id) ?? getStarfenDeltaSpecies(id) ?? getGloamwoodSpecies(id) ?? getWaymeetMarchesSpecies(id); }
export function getCanonicalPopulation(id) { return getPopulation(id) ?? getRegionalPopulation(id) ?? getDryUplandSaltpanRepairPopulation(id) ?? getElderwoodRepairPopulation(id) ?? getEmberwashPopulation(id) ?? getLowerDeepveinPopulation(id) ?? getGreatMerePopulation(id) ?? getIronspinePopulation(id) ?? getHeadwaterPopulation(id) ?? getStarfenDeltaPopulation(id) ?? getGloamwoodPopulation(id) ?? getWaymeetMarchesPopulation(id); }
...
export function validateEcologyRegistry() {
    ...
    const collections = [
        ['family', [...listEcologyFamilies(), ...listRegionalEcologyFamilies(), ...listDryUplandSaltpanRepairEcologyFamilies(), ...listElderwoodRepairEcologyFamilies(), ...listEmberwashEcologyFamilies(), ...listLowerDeepveinEcologyFamilies(), ...listGreatMereEcologyFamilies(), ...listIronspineEcologyFamilies(), ...listHeadwaterEcologyFamilies(), ...listStarfenDeltaEcologyFamilies(), ...listGloamwoodEcologyFamilies(), ...listWaymeetMarchesEcologyFamilies()]],
        ['species', [...listSpecies(), ...listRegionalSpecies(), ...listDryUplandSaltpanRepairSpecies(), ...listElderwoodRepairSpecies(), ...listEmberwashSpecies(), ...listLowerDeepveinSpecies(), ...listGreatMereSpecies(), ...listIronspineSpecies(), ...listHeadwaterSpecies(), ...listStarfenDeltaSpecies(), ...listGloamwoodSpecies(), ...listWaymeetMarchesSpecies()]],
